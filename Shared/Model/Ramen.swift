...
let ramens = [
    ...
    Ramen(ramenImage: "arigatou", ramenName: "Miso Ramen", ramenRating: "⭐⭐⭐⭐⭐", ramenRatingNum: "4.8/5 (178)", ramenDesc: "A savory miso-based broth combined with chicken or pork, with thick noodles and toppings like sliced pork, bean sprouts, corn, and butter.", price: "$8.9"),
